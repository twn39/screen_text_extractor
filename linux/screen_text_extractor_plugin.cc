...
G_DEFINE_TYPE(ScreenTextExtractorPlugin, screen_text_extractor_plugin,
              g_object_get_type())

static FlMethodResponse *
extract_from_screen_selection(ScreenTextExtractorPlugin *self, FlValue *args) {
...
static void
screen_text_extractor_plugin_handle_method_call(ScreenTextExtractorPlugin *self,
...
static void
screen_text_extractor_plugin_class_init(ScreenTextExtractorPluginClass *klass) {
...
void screen_text_extractor_plugin_register_with_registrar(
  ...
  g_autoptr(FlMethodChannel) channel =
      fl_method_channel_new(fl_plugin_registrar_get_messenger(registrar),
                            "screen_text_extractor", FL_METHOD_CODEC(codec));
